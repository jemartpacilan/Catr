                            ...
                            if (package.id == menus[menu].package && menus[menu].caterer === caterer.id) {
                                ...
                                $.ajax({
                                    ...
                                    $('.package_items').append('<div class = "package_items_container">' +
                                        '<input class = "item_name" type="text" name="' + menus[menu].id +
                                        '" value = "' + courses.course_name + '" readonly>'+'<input class="item_price" type="number" readonly value="' +
                                        courses.course_price + '" name="' + menus[menu].id + 'x">'+'<input class = "item_quantity" value="1" ' +
